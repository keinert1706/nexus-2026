...
2. Cambia lo que necesites:
   ...
   - `eventStartISO` / `eventEndISO` → la fecha/hora real de inicio y fin que se usa para los botones de calendario (formato `AAAA-MM-DDTHH:MM:SS-05:00`). **Actualiza esto junto con `dateLabel`** para que el calendario coincida con lo que dice la landing.
